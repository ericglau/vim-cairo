...
if [ ! -f ~/.vim/cairo-ls/cairo-ls-0.0.8.vsix ]; then curl -fLo ~/.vim/cairo-ls/cairo-ls-0.0.8.vsix --create-dirs https://github.com/ericglau/cairo-ls/releases/download/v0.0.8/cairo-ls-0.0.8.vsix; else echo "cairo-ls-0.0.8.vsix already exists - skipping"; fi
rm -rf vscode-cairo
unzip -d vscode-cairo ~/.vim/cairo-ls/cairo-ls-0.0.8.vsix
mkdir ~/.vim/cairo-ls
